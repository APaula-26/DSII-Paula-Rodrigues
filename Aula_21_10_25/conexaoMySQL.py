...
def create_connection(host_name, user_name, user_password, db_name): # def função para criar conecxao 
    connection = None
    try: #vai tratar algum erro de conecxao e se não tiver erros vai apresentar conexão bem sucedida
...
if __name__ == '__main__':
    ...
    # qual o banco que vai estar conectando
